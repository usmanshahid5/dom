    ...
    i.prototype = {
        ...
        init: function() {
            ...
            t.timeout = setTimeout(function() {
                ...
                var e;
                e = t.isInput ? t.el.value : "html" === t.contentType ? t.el.innerHTML : t.el.textContent, 0 == e.length ? t.typewrite(t.strings[t.sequence[t.arrayPos]], t.strPos) : t.backspace(e, e.length)
            }, t.startDelay)
        },
        build: function() {
            var t = this;
        ...
        typewrite: function(t, s) {
            if (this.stop !== !0) {
                ...
                i.timeout = setTimeout(function() {
                    ...
                    if ("^" === r.charAt(0)) {
                        var n = 1;
                        /^\^\d+/.test(r) && (r = /\d+/.exec(r)[0], n += r.length, e = parseInt(r)), t = t.substring(0, s) + t.substring(s + n)
                    }
                    if ("html" === i.contentType) {
                        ...
                        if ("<" === o || "&" === o) {
                            var a = "",
                                h = "";
                            for (h = "<" === o ? ">" : ";"; t.substr(s + 1).charAt(0) !== h && (a += t.substr(s).charAt(0), s++, !(s + 1 > t.length)););
                            s++, a += h
                        }
                    }
                    i.timeout = setTimeout(function() {
        ...
        return this.each(function() {
            var s = e(this),
                r = s.data("typed"),
                n = "object" == typeof t && t;
            r && r.reset(), s.data("typed", r = new i(this, n)), "string" == typeof t && r[t]()
        })
    }), t.Typed = i;
    var r = {
